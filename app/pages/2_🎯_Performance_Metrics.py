...
st.image("images/IoU_Metric.jpg", caption="IoU Metric Definition", width=200)

st.write("**Training Vs Validation IoU Trend From Model**")
st.image("images/IOU_Metric_Trend.png", caption="IoU Metric Definition", width=800)
...
st.image("images/Loss_Trend.png", caption="IoU Metric Definition", width=800)
